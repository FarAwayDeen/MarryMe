...
//var app = angular.module('MarrymeClientModule', ['ui.bootstrap', 'ngFileUpload']);
var app = angular.module('MarrymeClientModule', ['ui.bootstrap']);
...
function Print() {
    ...
    WinPrint.document.write(`
               <link rel="stylesheet" href="/Content/bootstrap 4/css/bootstrap.css">
...
function LabelYesNo(isActive) {
    ...
    return (isActive ? '<span class="label label-success">Yes</span>' : '<span class="label label-warning">No</span>');
...
function SuccessMessage(msg) {
    //console.log("success main function called:" + msg);
    iziToast.success({
        id: 'success',
        title: 'Success',
        message: msg,
...
function ShowMessage(msg) {
    ...
    if (!($.type(msg.Detail) === "undefined")) {
        ...
        if (msg.Info) {
            ...
            //console.log("Success msg function called: "+ msg.Detail);
