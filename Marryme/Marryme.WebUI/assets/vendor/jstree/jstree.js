...
/*jshint -W083 */
	...
	$.jstree.core.prototype = {
		...
		_create_prototype_node : function () {
			...
			//_temp3Add = document.createElement('I');
			_temp1.className = 'jstree-icon jstree-ocl';
			//_temp3Add.className = 'fa fa-plus-circle';

			//_temp3Add.addEventListener("ng-click", myFunction);
		...
		redraw_node : function (node, deep, is_callback, force_render) {
			...
			if(!obj.a_attr.id) {
			    ...
			    obj.a_attr.title = obj.original.description == null || obj.original.description == "null" ? "" : obj.original.description;
			}
			node.setAttribute('aria-selected', !!obj.state.selected);
			node.setAttribute('aria-level', obj.parents.length);
			node.setAttribute('aria-labelledby', obj.a_attr.id);
			node.setAttribute('title', obj.a_attr.title);
