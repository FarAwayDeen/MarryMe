USE [master]
GO
/****** Object:  Database [Marryme]    Script Date: 06/02/22 9:55:45 PM ******/
CREATE DATABASE [Marryme]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Marryme', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MYSQL\MSSQL\DATA\Marryme.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Marryme_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MYSQL\MSSQL\DATA\Marryme_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
ALTER DATABASE [Marryme] SET COMPATIBILITY_LEVEL = 140
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Marryme].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [Marryme] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [Marryme] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [Marryme] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [Marryme] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [Marryme] SET ARITHABORT OFF 
GO
ALTER DATABASE [Marryme] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [Marryme] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [Marryme] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [Marryme] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [Marryme] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [Marryme] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [Marryme] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [Marryme] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [Marryme] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [Marryme] SET  DISABLE_BROKER 
GO
ALTER DATABASE [Marryme] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [Marryme] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [Marryme] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [Marryme] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [Marryme] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [Marryme] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [Marryme] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [Marryme] SET RECOVERY FULL 
GO
ALTER DATABASE [Marryme] SET  MULTI_USER 
GO
ALTER DATABASE [Marryme] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [Marryme] SET DB_CHAINING OFF 
GO
ALTER DATABASE [Marryme] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [Marryme] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Marryme] SET DELAYED_DURABILITY = DISABLED 
GO
EXEC sys.sp_db_vardecimal_storage_format N'Marryme', N'ON'
GO
ALTER DATABASE [Marryme] SET QUERY_STORE = OFF
GO
USE [Marryme]
GO
/****** Object:  Table [dbo].[ActivityLog]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[AdminProfile]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ApplicationSettings]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Attachements]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChatFriendRequest]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChatHistoryDeletedMember]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChatMessage]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChatSession]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Cities]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ContactUs]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Countries]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DocumentTypes]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EmailSMSTemplate]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ErrorLog]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FeedBack]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FieldsPermission]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Languages]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MarriageDuration]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberAppearance]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberEducationDetail]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberFamilyDetail]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberLanguages]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberLifeStyle]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberLikeDislike]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberLocationDetail]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberLoginDetail]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberPackageConfirmPayment]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberPackagePayment]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberPackageSubscription]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberPackageSubscriptionDetail]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MemberRegistration]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MenCurrentState]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Notification]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NumberOfMarriage]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Package]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PackagePricingPlan]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PackageType]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PageContent]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PaymentOptions]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProposalQuestions]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Religion]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ReligionSect]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[States]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[WomenCurrentState]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[WomenFacilities]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[WomenFacilities](
	[ID] [int] IDENTITY(1,1) NOT NULL,
	[WomenFacilities] [nvarchar](50) NULL,
	[CreatedDate] [datetime] NULL,
	[CreatedBy] [nvarchar](50) NULL,
	[UpdatedDate] [datetime] NULL,
	[UpdatedBy] [nvarchar](50) NULL,
...
GO
/****** Object:  Table [dbo].[WomenResponsibilities]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[WomenRights]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[AdminProfile] ([Id], [FirstName], [LastName], [Email], [Password], [ProfilePicture], [Phone], [Address]) VALUES (1, N'Muzammil', N'Ulde', N'admin@gharjode.in', N'Admin@1234', N'06-10-2020-10-206373756200454395330.JPG', N'74496272', N'test changing profile')
GO
SET IDENTITY_INSERT [dbo].[AdminProfile] OFF
GO
SET IDENTITY_INSERT [dbo].[ApplicationSettings] ON 
GO
INSERT [dbo].[ApplicationSettings] ([Id], [ApplicationName], [Logo], [Address], [Phone], [Email], [FaceBookLink], [GoogleLink], [TwitterLink], [SkypeLink], [NTN], [CompanyName], [MailingAddress], [IsActive], [CreatedBy], [CreatedDateTime], [UpdatedBy], [UpdatedDateTime]) VALUES (1, N'Ghar Jode', N'02-11-2020-05-486373987490990403250.png', N'Sara Complex Office No.9 Mhasla Shriwardhan Road, next to SBI ATM, Mhasala Rd, Mhasala, Maharashtra 402105, India', N'+91 8623811658', N'gharjode2010@gmail.com', N'https://www.facebook.com', N'google.com', N'twitter.com', N'skype.com', N'12345', N'Gharjode', N'At-Post Mhasla,Raigad,Maharashtra', 1, NULL, CAST(N'2020-07-28T16:12:36.000' AS DateTime), NULL, CAST(N'2020-11-02T00:48:29.577' AS DateTime))
GO
...
GO
INSERT [dbo].[Cities] ([CityID], [Name], [StateID]) VALUES (1, N'Lahore', 6)
GO
INSERT [dbo].[Cities] ([CityID], [Name], [StateID]) VALUES (2, N'Gujranwala', 6)
GO
SET IDENTITY_INSERT [dbo].[Cities] OFF
GO
SET IDENTITY_INSERT [dbo].[Countries] ON 
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (1, N'Andorra', N'AD')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (2, N'United Arab Emirates', N'AE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (3, N'Afghanistan', N'AF')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (4, N'Antigua And Barbuda', N'AG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (5, N'Albania', N'AL')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (6, N'Armenia', N'AM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (7, N'Angola', N'AO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (8, N'Antarctica', N'AQ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (9, N'Argentina', N'AR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (10, N'American Samoa', N'AS')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (11, N'Austria', N'AT')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (12, N'Australia', N'AU')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (13, N'Aruba', N'AW')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (14, N'Aland Islands', N'AX')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (15, N'Azerbaijan', N'AZ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (16, N'Bosnia And Herzegovina', N'BA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (17, N'Barbados', N'BB')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (18, N'Bangladesh', N'BD')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (19, N'Belgium', N'BE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (20, N'Burkina Faso', N'BF')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (21, N'Bulgaria', N'BG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (22, N'Bahrain', N'BH')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (23, N'Burundi', N'BI')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (24, N'Benin', N'BJ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (25, N'Bermuda', N'BM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (26, N'Brunei', N'BN')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (27, N'Bolivia', N'BO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (28, N'Bonaire, Saint Eustatius And Saba ', N'BQ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (29, N'Brazil', N'BR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (30, N'Bahamas', N'BS')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (31, N'Bhutan', N'BT')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (32, N'Bouvet Island', N'BV')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (33, N'Botswana', N'BW')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (34, N'Belarus', N'BY')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (35, N'Belize', N'BZ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (36, N'Canada', N'CA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (37, N'Democratic Republic Of The Congo', N'CD')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (38, N'Central African Republic', N'CF')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (39, N'Republic Of The Congo', N'CG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (40, N'Switzerland', N'CH')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (41, N'Ivory Coast', N'CI')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (42, N'Chile', N'CL')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (43, N'Cameroon', N'CM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (44, N'China', N'CN')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (45, N'Colombia', N'CO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (46, N'Costa Rica', N'CR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (47, N'Cuba', N'CU')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (48, N'Cape Verde', N'CV')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (49, N'Cyprus', N'CY')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (50, N'Czech Republic', N'CZ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (51, N'Germany', N'DE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (52, N'Djibouti', N'DJ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (53, N'Denmark', N'DK')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (54, N'Dominica', N'DM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (55, N'Dominican Republic', N'DO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (56, N'Algeria', N'DZ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (57, N'Ecuador', N'EC')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (58, N'Estonia', N'EE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (59, N'Egypt', N'EG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (60, N'Western Sahara', N'EH')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (61, N'Eritrea', N'ER')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (62, N'Spain', N'ES')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (63, N'Ethiopia', N'ET')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (64, N'Finland', N'FI')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (65, N'Fiji', N'FJ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (66, N'Micronesia', N'FM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (67, N'Faroe Islands', N'FO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (68, N'France', N'FR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (69, N'Gabon', N'GA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (70, N'United Kingdom', N'GB')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (71, N'Grenada', N'GD')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (72, N'Georgia', N'GE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (73, N'French Guiana', N'GF')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (74, N'Guernsey', N'GG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (75, N'Ghana', N'GH')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (76, N'Greenland', N'GL')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (77, N'Gambia', N'GM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (78, N'Guinea', N'GN')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (79, N'Guadeloupe', N'GP')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (80, N'Equatorial Guinea', N'GQ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (81, N'Greece', N'GR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (82, N'Guatemala', N'GT')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (83, N'Guam', N'GU')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (84, N'Guinea-Bissau', N'GW')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (85, N'Guyana', N'GY')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (86, N'Hong Kong', N'HK')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (87, N'Honduras', N'HN')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (88, N'Croatia', N'HR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (89, N'Haiti', N'HT')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (90, N'Hungary', N'HU')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (91, N'Indonesia', N'ID')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (92, N'Ireland', N'IE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (93, N'Israel', N'IL')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (94, N'Isle Of Man', N'IM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (95, N'India', N'IN')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (96, N'British Indian Ocean Territory', N'IO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (97, N'Iraq', N'IQ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (98, N'Iran', N'IR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (99, N'Iceland', N'IS')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (100, N'Italy', N'IT')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (101, N'Jersey', N'JE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (102, N'Jamaica', N'JM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (103, N'Jordan', N'JO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (104, N'Japan', N'JP')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (105, N'Kenya', N'KE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (106, N'Kyrgyzstan', N'KG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (107, N'Cambodia', N'KH')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (108, N'Kiribati', N'KI')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (109, N'Comoros', N'KM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (110, N'Saint Kitts And Nevis', N'KN')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (111, N'North Korea', N'KP')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (112, N'South Korea', N'KR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (113, N'Kuwait', N'KW')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (114, N'Kazakhstan', N'KZ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (115, N'Laos', N'LA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (116, N'Lebanon', N'LB')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (117, N'Saint Lucia', N'LC')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (118, N'Liechtenstein', N'LI')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (119, N'Sri Lanka', N'LK')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (120, N'Liberia', N'LR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (121, N'Lesotho', N'LS')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (122, N'Lithuania', N'LT')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (123, N'Luxembourg', N'LU')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (124, N'Latvia', N'LV')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (125, N'Libya', N'LY')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (126, N'Morocco', N'MA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (127, N'Monaco', N'MC')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (128, N'Moldova', N'MD')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (129, N'Montenegro', N'ME')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (130, N'Madagascar', N'MG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (131, N'Marshall Islands', N'MH')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (132, N'Macedonia', N'MK')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (133, N'Mali', N'ML')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (134, N'Myanmar', N'MM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (135, N'Mongolia', N'MN')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (136, N'Macao', N'MO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (137, N'Northern Mariana Islands', N'MP')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (138, N'Martinique', N'MQ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (139, N'Mauritania', N'MR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (140, N'Montserrat', N'MS')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (141, N'Mauritius', N'MU')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (142, N'Maldives', N'MV')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (143, N'Malawi', N'MW')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (144, N'Mexico', N'MX')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (145, N'Malaysia', N'MY')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (146, N'Mozambique', N'MZ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (147, N'Namibia', N'NA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (148, N'New Caledonia', N'NC')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (149, N'Niger', N'NE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (150, N'Nigeria', N'NG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (151, N'Nicaragua', N'NI')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (152, N'Netherlands', N'NL')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (153, N'Norway', N'NO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (154, N'Nepal', N'NP')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (155, N'Nauru', N'NR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (156, N'New Zealand', N'NZ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (157, N'Oman', N'OM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (158, N'Panama', N'PA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (159, N'Peru', N'PE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (160, N'French Polynesia', N'PF')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (161, N'Papua New Guinea', N'PG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (162, N'Philippines', N'PH')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (163, N'Pakistan', N'PK')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (164, N'Poland', N'PL')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (165, N'Saint Pierre And Miquelon', N'PM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (166, N'Puerto Rico', N'PR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (167, N'Palestinian Territory', N'PS')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (168, N'Portugal', N'PT')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (169, N'Palau', N'PW')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (170, N'Paraguay', N'PY')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (171, N'Qatar', N'QA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (172, N'Reunion', N'RE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (173, N'Romania', N'RO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (174, N'Serbia', N'RS')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (175, N'Russia', N'RU')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (176, N'Rwanda', N'RW')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (177, N'Saudi Arabia', N'SA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (178, N'Solomon Islands', N'SB')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (179, N'Seychelles', N'SC')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (180, N'Sudan', N'SD')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (181, N'Sweden', N'SE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (182, N'Singapore', N'SG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (183, N'Saint Helena', N'SH')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (184, N'Slovenia', N'SI')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (185, N'Svalbard And Jan Mayen', N'SJ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (186, N'Slovakia', N'SK')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (187, N'Sierra Leone', N'SL')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (188, N'San Marino', N'SM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (189, N'Senegal', N'SN')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (190, N'Somalia', N'SO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (191, N'Suriname', N'SR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (192, N'South Sudan', N'SS')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (193, N'Sao Tome And Principe', N'ST')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (194, N'El Salvador', N'SV')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (195, N'Syria', N'SY')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (196, N'Swaziland', N'SZ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (197, N'Chad', N'TD')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (198, N'French Southern Territories', N'TF')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (199, N'Togo', N'TG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (200, N'Thailand', N'TH')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (201, N'Tajikistan', N'TJ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (202, N'Tokelau', N'TK')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (203, N'East Timor', N'TL')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (204, N'Turkmenistan', N'TM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (205, N'Tunisia', N'TN')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (206, N'Tonga', N'TO')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (207, N'Turkey', N'TR')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (208, N'Trinidad And Tobago', N'TT')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (209, N'Tuvalu', N'TV')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (210, N'Taiwan', N'TW')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (211, N'Tanzania', N'TZ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (212, N'Ukraine', N'UA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (213, N'Uganda', N'UG')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (214, N'United States Minor Outlying Islands', N'UM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (215, N'United States', N'US')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (216, N'Uruguay', N'UY')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (217, N'Uzbekistan', N'UZ')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (218, N'Saint Vincent And The Grenadines', N'VC')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (219, N'Venezuela', N'VE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (220, N'U.S. Virgin Islands', N'VI')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (221, N'Vietnam', N'VN')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (222, N'Vanuatu', N'VU')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (223, N'Wallis And Futuna', N'WF')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (224, N'Samoa', N'WS')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (225, N'Kosovo', N'XK')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (226, N'Yemen', N'YE')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (227, N'Mayotte', N'YT')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (228, N'South Africa', N'ZA')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (229, N'Zambia', N'ZM')
GO
INSERT [dbo].[Countries] ([CountryID], [CountryName], [CountryCode]) VALUES (230, N'Zimbabwe', N'ZW')
GO
...
GO
INSERT [dbo].[EmailSMSTemplate] ([Id], [Type], [Name], [CC], [BCC], [Subject], [MessageBody], [IsActive], [CreatedDate], [CreatedBy], [UpdatedBy], [UpdatedDate]) VALUES (4, N'Email', N'AccountActivationRequest', NULL, NULL, N'Matrimony Account Activation Request', N'
		...
		<div style="width: 90%;margin: auto;">
			<div>
				...
				<a href="{#!RequestLink!#}">Click Here</a> To activate your account.
				<p style="margin-top: 20px;margin-bottom: 0px">Thank you!</p>
				<p style="margin-top: 2px;">Team Matrimony</p>
			</div>
			<div style="text-align: center;background: #f5f5f5;padding: 15px 0;font-size: 13px;position: absolute;bottom: 0;left: 0;right: 0;margin: 0 -54px;">
				<p style="margin:0;">© {#!CurrentDate!#} Matrimony Management System Inc.</p>
...
GO
INSERT [dbo].[MemberLoginDetail] ([Id], [MemberId], [Email], [Password], [IsEmailConfirmed], [ConfirmationCode], [IsActive], [IsFirstLoginAttempt], [IsMobileUser], [FirebaseUserId]) VALUES (10062, 22, N'awais.ramzan.ar@gmail.com', N'GwK6Rt837NEkC5qaSbV31Cz+RvM4TLwuzMKyVE4BJUk=', 1, N'Mbct2eIpcUX48n18', 1, 0, 1, N'Z6YF2xNbpKNULeRLErcucC11UsM2')
GO
...
GO
INSERT [dbo].[MemberLoginDetail] ([Id], [MemberId], [Email], [Password], [IsEmailConfirmed], [ConfirmationCode], [IsActive], [IsFirstLoginAttempt], [IsMobileUser], [FirebaseUserId]) VALUES (10069, 29, N'awais.ramzan@gmail.com', N'Z6VRscgsMeacItvJJmD6kSGkNTny4n9woEfCkSb9L9Y=', 1, N'Btun4PRs9y7DOAJS', 1, 0, 0, NULL)
GO
...
GO
INSERT [dbo].[States] ([StateID], [Name], [CountryID], [CreatedBy], [CreatedDate], [UpdatedDate], [UpdatedBy]) VALUES (12, N'Gujarat', 163, NULL, NULL, NULL, NULL)
GO
...
GO
/****** Object:  StoredProcedure [dbo].[AdminReporting]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[DisableCurrentMemberPackageIfExpired]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[FetchAstroMatches]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchChatFriendList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchChatMemberConversation]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchChatMemberList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchCities]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchCitiesAdminList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[FetchConfirmPaymentAdminList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[FetchConfirmPaymentClientList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchContactUs]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchContactUsNotification]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchCountries]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchCountriesAdminList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchCountryNameByMemberId]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchFeedBack]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchFeedBackAdminList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchFeedBackNotification]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchInfoForPersonalProfileCard]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchLanguages]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchMemberAdminList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchMemberDetail]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
BEGIN
SELECT mr.Id,mr.Name,mr.IsMobilePic,mr.ProfileCreatedBy,mr.DOB,mr.MaritalStatus,mr.MobileNo,mr.Subcast,mr.AboutMe,mr.ProfilePicPath,c.Name as Country,s.Name as State,ci.Name as City,r.Name as Religion,
me.HighestEducation,me.Occupation,me.EmployeedIn,CONCAT (me.IncomeCurrency,' ',me.AnnualIncome) as AnualIncome,l.Name as Language,ls.DrinkingHabit,ls.SmokingHabit,ls.EatingHabit,
...
LEFT JOIN [dbo].[Countries] c ON mr.CountryId=c.Id
LEFT JOIN [dbo].[States] s ON s.StateID=c.Id
...
END
GO
/****** Object:  StoredProcedure [dbo].[FetchMemberFieldPermission]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchMemberList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
BEGIN
SELECT Count(mr.Id) over() totalcount, mr.Id,mr.Name,mr.DOB,mr.Gender,mr.ProfilePicPath,mr.IsMobilePic,e.HighestEducation,r.Name as Religion,c.Name as Country,mr.NickName
FROM [dbo].[MemberRegistration] mr 
left join [dbo].[MemberEducationDetail] e on mr.Id=e.MemberId
left join [dbo].[Religion] r on mr.ReligionId=r.Id
left join [dbo].[Countries] c on mr.CountryId=c.Id
...
END
GO
/****** Object:  StoredProcedure [dbo].[FetchMemberSubscription]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchNewlyRegisteredMemberList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchOrderSummary]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchPackagePricingPlans]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchPackages]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchPackagesDuration]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchPackageSubscription]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchPackageType]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchPaymentOptionddl]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchPaymentOptions]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchPremiumBestMatches]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
BEGIN
SELECT top(15) mr.Id,mr.NickName,mr.IsMobilePic,mr.Name,mr.DOB,mr.Gender,mr.ProfilePicPath,e.HighestEducation,r.Name as Religion,c.Name as Country,
...
GO
/****** Object:  StoredProcedure [dbo].[FetchPremiumMember]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchProfileLocationDetail]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
From MemberRegistration m
left JOIN Countries c on m.CountryId=c.Id
...
GO
/****** Object:  StoredProcedure [dbo].[FetchProfilePersonalInfo]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
BEGIN
SELECT mld.Email,mr.Id,mr.IsMobilePic,mr.Subcast,mr.MaritalStatus,mr.NoOfChildren,mr.Gender,mr.LookingFor,mr.ProfilePicPath,ma.Height,ma.PhysicalStatus
FROM 
MemberRegistration mr 
Inner Join MemberLoginDetail mld on mld.MemberId=mr.Id
...
GO
/****** Object:  StoredProcedure [dbo].[FetchProfilePersonalInfoDetail]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT ma.MemberId,ma.Weight,ma.BodyType,ma.Complexion,ed.Occupation,ls.DrinkingHabit,ls.SmokingHabit,ls.EatingHabit,ls.Hobbies,ls.Interests,ml.LanguageId
FROM [dbo].[MemberRegistration] mr
...
GO
/****** Object:  StoredProcedure [dbo].[FetchStates]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[FetchStatesAdminList]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetPackageRemainingWeeksByMemberId]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[MembersFetch]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
mr.Id, ISNULL(mr.Name,'') MemberName ,mr.AboutMe,mr.Gender,mr.LookingFor,mr.MaritalStatus,mr.Subcast,mld.Email,mld.IsActive,mr.CountryId,mr.DOB,mld.Id as MemberLoginDetailId,mr.MobileNo,mr.MotherTongue,mr.ProfilePicPath
from [dbo].[MemberRegistration] mr
inner join MemberLoginDetail mld on mld.MemberId=mr.Id
...
END
GO
/****** Object:  StoredProcedure [dbo].[Packages]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[PageContents]    Script Date: 06/02/22 9:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
